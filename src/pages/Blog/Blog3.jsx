...
function Blog3() {
    ...
    return (
        <>
            ...
            <HeaderRes />
            <BannerAllProducts title=" Cách làm bàn học gọn gàng bằng kệ giữ sách sáng tạo" blog />
            <div className="container mx-auto mt-10">
                <div className="row flex flex-col-reverse lg:flex-row gap-10">
                    <SelectCategoryBlog />
                    <div className="basis-3/4 sm:px-0 px-4">
                        <InfoBlog title=" Cách làm bàn học gọn gàng bằng kệ giữ sách sáng tạo" date="12/04/18" commentCount={0} author="Suplo Wood"/>
